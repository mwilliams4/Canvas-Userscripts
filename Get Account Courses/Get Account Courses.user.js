...
(function () {
    ...
    async function processRequest() {
        ...
        csvArr.push(headers, ...filteredCourses.map(course => Object.values(course)));
    ...
    async function getCourses() {
        ...
        while (flag === false) {
            ...
            try {
                ...
                console.log(`Fetched from pages ${iteration*asyncRequests+1} to ${iteration*asyncRequests+asyncRequests}.`);
